...
const calculateValue = () => {
    ...
    for (const name in envs) {
        if (name.startsWith('BILIBILI_COOKIE_')) {
            ...
            bilibili_cookies_510283440 = SESSDATA=f7fb5913%2C1743176791%2Cff308%2A91CjAVBqDy2y4RbISfP2jsigIa_Nq8YMXCmpi4KgZd031fIs7iiPvIlC1OLk5DREQPXDYSVjNKYXdNNkVRZVFHdEhTSnFQWE80Nzdaa3NXV0Z4QzJ4UE9ld1VDSzRQSkJ6TVdhdDdQRXlxMURTd01RelkxVHVLMzA3WjJfSklFUzJHUjJLM21uV3FnIIEC    } else if (name.startsWith('EMAIL_CONFIG_')) {
